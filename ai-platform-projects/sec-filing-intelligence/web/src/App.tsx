...
import { fetchHealth, streamResearch } from "./api";
import { Findings } from "./components/Findings";
import { StatTiles } from "./components/StatTiles";
import { Timeline } from "./components/Timeline";
import type { Finding, Health, ResearchResult, TimelineStep } from "./types";
    ...
    <div className="shell">
      ...
      {health?.provider === "demo" && (
        <div className="notice">
          <strong>Demo mode.</strong> Filings and figures are pulled live from SEC
          EDGAR and quoted verbatim, but there is no model in the loop — passages
          are selected by keyword overlap, not comprehension. So it can quote, but
          it cannot summarise, compare across filings, or decline an unanswerable
          question. Set <code>ANTHROPIC_API_KEY</code> and{" "}
          <code>FILING_INTEL_PROVIDER=anthropic</code> for real reasoning.
        </div>
      )}
      ...
      <footer>
        ...
        .{" "}
        {health?.provider === "demo"
          ? "Passages are quoted verbatim from the filings shown."
          : "Research output is generated by a language model."}{" "}
